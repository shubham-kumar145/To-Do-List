...
//       <div
//         className=" sm:max-h-[86.5vh] md:max-h-[90.5vh] sm:w-[29.5%] mt-3 sm:mt-0 bg-rose-300 rounded-2xl lg:p-4 lg:space-y-4 overflow-y-scroll custom-scrollbar"
//       >
...
//                     className="w-full bg-gradient-to-br from-amber-100 to-yellow-200 border border-blue-300 shadow-md p-4 sm:p-1 lg:p-4 rounded-2xl hover:shadow-xl transition  border-l-6"
//                   >
