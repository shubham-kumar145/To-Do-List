...
//         setIsSignup((prev) => {
//             const newState = !prev;
//             localStorage.setItem('isSignup', newState); // sync localStorage manually
//             return newState;
//         });
//         resetSignup();
//         resetSignin();
...
//                 <i className="fab fa-facebook-f bg-blue-600 text-white h-9 w-9 px-3 py-2.5 rounded-full hover:scale-110 transition"></i>
//                 <i className="fab fa-google-plus-g bg-red-500 text-white h-9 w-9 px-2 py-2.5 rounded-full hover:scale-110 transition"></i>
//                 <i className="fab fa-linkedin-in bg-blue-800 text-white h-9 w-9 px-2.5 py-2.5 rounded-full hover:scale-110 transition"></i>
//             </div>
//         </>
//     );
...
//             <Deatilsnavbar />
//             <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-100 to-blue-200 px-4 pt-18">
...
//                             <h2 className="text-3xl font-bold text-center text-amber-600 mb-6">SignUp</h2>
...
//                                             })}
//                                             className="border p-3 rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500 w-full pr-12"
//                                         />
...
//                                     className="bg-amber-500 hover:bg-amber-600 text-white py-3 rounded-lg mt-2 font-semibold transition"
//                                 >
...
//                             <div className="sm:hidden bg-gradient-to-br from-amber-500 to-orange-600 text-white flex flex-col justify-center items-center p-6 rounded-xl shadow-lg gap-4 mt-7">
...
//                                     className="bg-white text-amber-600 px-6 py-2 rounded-full font-semibold hover:bg-gray-100 shadow-md transition-all duration-300 hover:scale-105"
//                                 >
...
//                             <h2 className="text-3xl font-bold text-center text-amber-600 mb-6">SignIn</h2>
...
//                     {/* Side Panel */}
//                     <div className={`absolute top-0 right-[200%] sm:right-0 h-full w-full sm:w-1/2 flex flex-col items-center z-20 justify-center bg-gradient-to-br from-amber-400 via-amber-500 to-amber-600 text-white px-6 py-12 transition-all duration-700 ease-in-out
...
//                                         We've missed you!<br />
//                                         <span className="text-amber-800">Log in</span> to continue your journey and stay connected with the community.
//                                     </p>
//                                 </>
//                             ) : (
//                                 <p className="text-lg font-medium leading-relaxed">
//                                     Ready to explore?<br />
//                                     <span className="text-amber-800">Create your account</span> now and unlock exclusive features!
//                                 </p>
//                             )}
//                         </div>
...
//                         <button
//                             onClick={handleToggle}
//                             className="bg-white text-amber-600 px-6 py-2 rounded-full font-semibold hover:bg-gray-100 transition"
//                         >
